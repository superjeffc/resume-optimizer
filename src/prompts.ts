...
export function getAtsSystemPrompt(currentYear: number = new Date().getFullYear()): string {
...
export function getGrammarSystemPrompt(currentYear: number = new Date().getFullYear()): string {
...
export function getEditorSystemPrompt(pageLabel: string, currentYear: number = new Date().getFullYear()): string {
